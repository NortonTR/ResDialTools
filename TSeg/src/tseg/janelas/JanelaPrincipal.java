...
public class JanelaPrincipal {
	...
	private AcaoJanelaPrincipal acao = new AcaoJanelaPrincipal();
        ...
        static private JMenu menuCodificacao;
        static private JMenuItem itemUTF8;
        static private JMenuItem itemUTF16;
        static private JMenuItem itemIso88591;
        static private JMenuItem itemUsASCII;
		...
		try {
			...
			if (scanner.hasNext()) {
				ultimoArquivo = new File(scanner.nextLine());
                                Configuracoes.ULTIMO_ARQUIVO = ultimoArquivo;
				scanner.close();
	...
	private JMenu montaMenuCores() {
        ...
        private JMenu montaMenuCodificacao()
        {
            menuCodificacao = new JMenu("Codificação");
            menuCodificacao.setMnemonic('C');
            
            itemUTF8 = new JMenuItem("UTF-8");
            itemIso88591 = new JMenuItem("ISO-8859-1");
            itemUTF16 = new JMenuItem("UTF-16");
            itemUsASCII = new JMenuItem("US-ASCII");
            
            menuCodificacao.add(itemUTF8);
            menuCodificacao.add(itemIso88591);
            menuCodificacao.add(itemUTF16);
            menuCodificacao.add(itemUsASCII);
            
            itemUTF8.addActionListener(acao.itemUTF8());
            itemIso88591.addActionListener(acao.itemIso88591());
            itemUTF16.addActionListener(acao.itemUTF16());
            itemUsASCII.addActionListener(acao.itemUsASCII());
            
            chooseCurrentEncoding();
            
            return menuCodificacao;
        }
		...
		return new ActionListener() {
			...
			public void actionPerformed(ActionEvent evt) {
					if(portugues)
					{
                            ...
                            menuCodificacao.setText("Encoding");
					...
					else
					{
                        ...
                        menuCodificacao.setText("Codificação");
	...
	private void montaPainelAbas() {
        ...
        public static void chooseCurrentEncoding()
        {
            itemUTF8.setText("UTF-8");
            itemIso88591.setText("ISO-8859-1");
            itemUTF16.setText("UTF-16");
            itemUsASCII.setText("US-ASCII");
